...
//       required: true,
//     },
//     type: { type: String, enum: ["sell", "remove"], required: true },
//   },
//   { _id: false }
// ); // Disable _id for subdocuments if not needed

// // user_is upper player data Define the schema for user data in transactions
...
const transactionsSchema = new mongoose.Schema(
  {
    user_data: userTransactionSchema,
    players_data: [playerTransactionSchema],
    opening_credits: {
      type: Number,
      required: true,
    },
